...
echo "  Charlie has PermissionBinding for 'cluster3', not 'cluster1'"
...
echo ""
echo "Tests covered:"
echo "  1. Alice - Has hub PermissionBinding for cluster1 (viewer role - Allowed/Denied by auth-server)"
echo "  2. Bob - Has hub PermissionBinding for cluster1 and cluster2 (admin role - Allowed/Denied by auth-server)"
echo "  3. Charlie - Has hub PermissionBinding for cluster3, not cluster1 (NoOpinion from auth-server,"
